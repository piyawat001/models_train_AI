"""
EfficientNetV2 โมเดลสำหรับการจำแนกประเภทภาพรังสี
"""
...
BATCH_SIZE = int(os.getenv('BATCH_SIZE', '16'))  # ค่าเริ่มต้นให้เหมาะสมกับ GPU 3080 ที่มี VRAM 10GB
...
# สร้างโมเดล EfficientNetV2
def create_model(num_classes):
    """สร้างโมเดล EfficientNetV2 และปรับแต่งให้เหมาะสมกับงานที่ต้องการ"""
    try:
...
def main():
    ...
    output_dir = 'efficientnet_outputs'
